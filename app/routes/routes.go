...
type tRestaurants struct {}
var Restaurants tRestaurants


func (_ tRestaurants) Index(
		restaurantName string,
		) string {
	args := make(map[string]string)
	
	revel.Unbind(args, "restaurantName", restaurantName)
	return revel.MainRouter.Reverse("Restaurants.Index", args).Url
}
